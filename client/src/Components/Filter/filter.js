...
import datePickerStyle from '../../../node_modules/react-datepicker/dist/react-datepicker-cssmodules.min.css';
...
class Filter extends Component {
  ...
  applyFilters() {
    ...
    const { city, min, max, guests } = this.state;
    ...
    return (
      <div styleName="filters">
        ...
        <div styleName="inputs">
          ...
          <div styleName="clean-filters" onClick={this.cleanFilters}>
            Reset
          </div>
        </div>
      </div>
...
export default CSSModules(Filter, { ...styles, ...datePickerStyle });
